...
import 'package:gstockdz/widgets.dart/Custom_Date.dart'; // Corrected import path
import 'package:gstockdz/widgets.dart/BUILDLIST.dart'; // Corrected import path
               ...
               children: [
                ...
                child: Center(
                  child: Text(
                    ...
                    title: '                                   تقرير بحركة الصندوق ',
                    callbackHandle2:() =>Navigator.pop(context)
                  ),
                  BuildListItem(
                    title: '                                           تقرير راس المال  ',
                    callbackHandle2:() =>Navigator.pop(context)
                  ),
                  BuildListItem(
                    title: '                                              حساب الزكاة',
